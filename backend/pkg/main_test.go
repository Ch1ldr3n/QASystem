	...
	AuxUserEdit(e, t, token1, `
{
	...
	`)
	AuxUserFilter(e, t, token2, "?id="+strconv.Itoa(userid2)+"&username=user1&email=hello@example&phone=12345678&answerer=true&priceUpperBound=1000&priceLowerBound=-1000&profession=Geschichte")
}
